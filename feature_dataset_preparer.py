...
import os
import json
from features.extended_minmax import ExtendedMinMaxScalar
...
columns_to_deserialize.remove("Unnamed: 0")
...
run_random_forest_model(X_train, X_test, y_train, y_test, 5)
